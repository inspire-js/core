...
console.warn(
	'Inspire.js has switched to ESM. Please use type="module" in your <script> element and import the .mjs file of the same name.',
);

let url = new URL(
	"./inspire.mjs",
	document.currentScript ? document.currentScript.src : "https://inspirejs.org/",
);
